...
# jukeslot types
# A different import line for each slot type
from simpleplaylist import *
from simplelive import *

# Add new slot types here
# from newfantasticjukeslot import *
